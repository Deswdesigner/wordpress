<?php 
    ...
    $title = ( isset($options['age_gateway_title']) && !empty($options['age_gateway_title']) ) ? $options['age_gateway_title'] : 'ENTER SITE';
    $sub_title = ( isset($options['age_gateway_sub_title']) && !empty($options['age_gateway_sub_title']) ) ? $options['age_gateway_sub_title'] : 'You must be the right age to access this page. Provide your Birth Day details below';
    $terms = ( isset($options['age_gateway_terms']) && !empty($options['age_gateway_terms']) ) ? $options['age_gateway_terms'] : '#';
    $privacy = ( isset($options['age_gateway_privacy']) && !empty($options['age_gateway_privacy']) ) ? $options['age_gateway_privacy'] : '#';
    $submit = ( isset($options['age_gateway_submit']) && !empty($options['age_gateway_submit']) ) ? $options['age_gateway_submit'] : 'ENTER';
    
    $html = sprintf('<div class="age-gate-way-overlay age-gate-way-none"> 
...
</div>', $title, $sub_title, $terms, $privacy, $submit);
?>
